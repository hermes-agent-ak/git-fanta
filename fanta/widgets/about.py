...
def authors_text():
    ...
    authors = (
        ...
        dict(name='Katsuhiko Takahashi', title=N_('Developer')),
        ...
        dict(name='Josh Taylor', title=N_('Developer')),
        ...
        dict(name='Ihor', title=N_('Developer')),
        dict(name='Jan Kurella', title=N_('Developer')),
        ...
        dict(name='legasik21', title=N_('Developer')),
        ...
        dict(name='Arnaud Henry', title=N_('Developer')),
        ...
        dict(name='Oleg', title=N_('Developer')),
        ...
        dict(name='Sabri Ünal', title=N_('Developer')),
        ...
        dict(name='William Wira', title=N_('Developer')),
        dict(name='Wolfgang Ocker', title=N_('Developer')),
        dict(name='Zhang Han', title=N_('Developer')),
        dict(name='akhilsayshi', title=N_('Developer')),
        ...
        dict(name='senique', title=N_('Developer')),
...
def translators_text():
    ...
    translators = (
        ...
        dict(name='Samuel Amen Ague', title=N_('French translation')),
        ...
        dict(name='Efimov Vasily', title=N_('Translation')),
        ...
        dict(name='PushKK', title=N_('Russian translation')),
        ...
        dict(name='K.T.', title=N_('Japanese translation')),
        dict(name='Kai Krakow', title=N_('German translation')),
        dict(name='Kisaragi Hiu', title=N_('Japanese translation')),
        ...
        dict(name='Stanislav', title=N_('Translation')),
        dict(name='Tomo Dote', title=N_('Translation')),
