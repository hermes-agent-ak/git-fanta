...
The `git fanta`, `git fanta-rebase-editor` and `git fanta-dag` Git sub-commands are
provided by the `git-fanta`, `git-fanta-rebase-editor` and `git-fanta-dag` setuptools
entry point scripts.
